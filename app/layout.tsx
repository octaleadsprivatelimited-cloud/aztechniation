          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "areaServed": [
                ...
                "Kukatpally", "Miyapur", "Serilingampally", "Lingampally", "Chandanagar", "Alwal",
                ...
                "Khairatabad", "Masab Tank", "Nampally", "Mehdipatnam", "Tolichowki",
                "Golconda", "Lakdi-ka-pul", "Lakadi Ka Pul", "Old City", "Abids", "Koti",
                ...
                "Raidurg", "Khajaguda", "Neknampur", "Narsingi", "Shankarpally", "Shankerpally",
                "Kapra", "Uppal Kalan", "Peerzadiguda", "Ghatkesar", "Medchal",
                "Shamirpet", "Sainikpuri", "Vikarabad", "Lakdikapul", "Falaknuma",
                "Santoshnagar", "Chandrayangutta", "Rangareddy", "Ibrahimpatnam",
                "Maheshwaram", "Mahabubnagar", "Medak", "Jogipet", "Sadashivpet",
                "Zaheerabad"
              ],
              "hasOfferCatalog": {
                "@type": "OfferCatalog",
